...
<link rel="stylesheet"  href="{{ asset('style/css/morris.css')}}" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet"  href="{{ asset('style/css/monthly.css')}}">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="asset('style/js/jquery2.0.3.min.js')}}"></script>
<script src="asset('style/js/raphael-min.js')}}"></script>
<script src="asset('style/js/morris.js')}}"></script>
</head>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle"  href="">
                <img alt="" src="{{asset('style/images/2.png')}}">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a  href="/user">Data Admin</a></li>
                        <li><a  href="/lapangan">Data Lapangan</a></li>
                        <li><a  href="/penyewa">Data Order</a></li>
                    </ul>
                </li>
                <li>
...
<!-- calendar -->
    <script type="text/javascript" src="asset('style/js/monthly.js')}}"></script>
